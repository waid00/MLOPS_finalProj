...
| **"The server is on fire, help!"** | *Technical Support* (Confidence: 0.19) | **Correct but Uncertain - Metaphor Confusion:** Model correctly categorized as IT/Technical but very low confidence (0.19) suggests it struggled with the metaphorical "fire" language and urgency indicators ("help! "). The crisis framing created ambiguity between technical incident, physical safety, or wellbeing emergency. | **Low Confidence = Ambiguity Signal:** While ultimately correct, the 0.19 confidence reveals the model cannot reliably distinguish technical metaphors from literal crises.  Should trigger human review or prompt clarification:  "Are you reporting a technical issue or an emergency?" |
...
4. **Metaphor Handling with Low Confidence** (server fire example): Model got the right category but extremely low confidence (0.19) reveals it cannot reliably parse technical jargon mixed with crisis language. The system "got lucky" rather than demonstrating robust understanding. 
...
- **Metaphor Training:** Expand training data to include common technical metaphors ("on fire," "firefighting," "bleeding edge," "crash") to improve confidence on correctly classified edge cases.
